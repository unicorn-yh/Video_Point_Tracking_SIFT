...
while video.isOpened():
    ...
    if old_frame is None:
        old_frame = new_frame
        #old_kp, old_des = computeKeypointsAndDescriptors(old_frame)
        old_kp, old_des = sift.detectAndCompute(old_frame, None)
        continue
    #kp2, des2 = computeKeypointsAndDescriptors(new_frame)
    ...
    cv2.moveWindow('Delta Position',600,30)
    cv2.moveWindow('Motion Tracker',100,30)
    cv2.moveWindow('Path',100,350)
